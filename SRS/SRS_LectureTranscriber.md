...
Tài liệu này mô tả đầy đủ các yêu cầu phần mềm cho hệ thống **Lecture Transcriber** — một ứng dụng ghi âm và chuyển đổi giọng nói thành văn bản (Speech-to-Text) theo thời gian thực, được tối ưu hóa cho môi trường bài giảng tiếng Việt. Tài liệu dành cho nhà phát triển, người kiểm thử và người dùng cuối.
...
Lecture Transcriber là công cụ CLI chạy trên máy tính cá nhân (Windows/Linux/macOS), không cần kết nối internet trong lúc vận hành. Người dùng mục tiêu là sinh viên hoặc giảng viên muốn tạo bản text của bài giảng tiếng Việt theo thời gian thực, không phụ thuộc cloud.
